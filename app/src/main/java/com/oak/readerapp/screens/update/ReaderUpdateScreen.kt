package com.oak.readerapp.screens.update
...
import com.oak.readerapp.components.*
...
@Composable
fun UpdateScreen(navController: NavHostController, bookId: String, viewModel: HomeScreenViewModel = hiltViewModel()) {
    Scaffold(topBar = {
        ReaderAppBar(
            title = "Update Book",
            ...
            Column(
                ...
                if (bookInfo.loading == true) {
                    ...
                    Surface(
                        ...
                        ShowBookUpdate(bookInfo = viewModel.data.value, bookId)
                    }
    ...
    Card(modifier = Modifier
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    text = if(book.authors.isNullOrEmpty()) "N/A" else book.authors.toString(),
